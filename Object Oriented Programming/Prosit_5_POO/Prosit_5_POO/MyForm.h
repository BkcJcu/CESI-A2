...
namespace testWin {
	...
	/// </summary>
	public ref class MyForm : public System::Windows::Forms::Form // ici, nous avons oublié d'appeller la classe mère, la classe de base pour la création de fenêtres (WinForm)
	{
	public:
		MyForm(void)
		{
...
#pragma region Windows Form Designer generated code
		   ...
		   void InitializeComponent(void)
		   {
			   ...
			   this->lbl_resultats->Size = System::Drawing::Size(61, 13);
...
#pragma endregion
	...
	private: System::Void MyForm_Load(System::Object^ sender, System::EventArgs^ e)
	{
		try {
			...
			MessageBox::Show("Erreur dans l'initialisation des variables index et nombreImages :" + e->Message, "Erreur", MessageBoxButtons::OK, MessageBoxIcon::Error);
		}
	...
	private: System::Void btn_source_Click(System::Object^ sender, System::EventArgs^ e) // -------------------------------------- //
	{
		try {
			...
			MessageBox::Show("Erreur dans la selection de la source :" + e->Message, "Erreur", MessageBoxButtons::OK, MessageBoxIcon::Error);
		}
	...
	private: System::Void btn_destination_Click(System::Object^ sender, System::EventArgs^ e)
	{
		try {
			...
			MessageBox::Show("Erreur dans la selection de la destination :" + e->Message, "Erreur", MessageBoxButtons::OK, MessageBoxIcon::Error);
		}
	...
	private: System::Void btn_first_Click(System::Object^ sender, System::EventArgs^ e)
	{
		try {
			...
			MessageBox::Show("Erreur de lecture de l'image (first) :" + e->Message, "Erreur", MessageBoxButtons::OK, MessageBoxIcon::Error);
		}
	...
	private: System::Void btn_proceder_Click(System::Object^ sender, System::EventArgs^ e)
	{
		...
		if (this->rdb_copier->Checked == true)
		{
			try {
				...
				MessageBox::Show("Erreur de copie des fichiers :" + e->Message, "Erreur", MessageBoxButtons::OK, MessageBoxIcon::Error);
			}
		...
		else if (this->rdb_coiperEffacer->Checked == true)
		{
			try {
				...
				MessageBox::Show("Erreur de copie + effacer des fichiers :" + e->Message, "Erreur", MessageBoxButtons::OK, MessageBoxIcon::Error);
			}
		}
			...
			try {
				...
				this->txt_rslt->Text = "Les fichiers de" + this->txt_destination->Text + "ont �t� effac�s";
			} catch (Exception^ e) {
				MessageBox::Show("Erreur d'effacement des fichiers :" + e->Message, "Erreur", MessageBoxButtons::OK, MessageBoxIcon::Error);
			}
		}
	}
	...
	private: System::Void btn_next_Click(System::Object^ sender, System::EventArgs^ e)
	{
		if (this->index < this->listeDeFichier->Length - 1)
		{
			try {
				...
				MessageBox::Show("Erreur de lecture de l'image (next) :" + e->Message, "Erreur", MessageBoxButtons::OK, MessageBoxIcon::Error);
			}
		}
	}
	...
	private: System::Void btn_previous_Click(System::Object^ sender, System::EventArgs^ e)
	{
		if (this->index > 0)
		{
			try {
				...
				MessageBox::Show("Erreur de lecture de l'image (previous) :" + e->Message, "Erreur", MessageBoxButtons::OK, MessageBoxIcon::Error);
			}
	...
	private: System::Void btn_last_Click(System::Object^ sender, System::EventArgs^ e)
	{
		try {
			...
			MessageBox::Show("Erreur de lecture de l'image (last) :" + e->Message, "Erreur", MessageBoxButtons::OK, MessageBoxIcon::Error);
		}
	}
	};
}